package br.com.eduardotanaka.androidrecipes.util;
 ...
 * Usage:
 *
 * int sampleInt = SharedPreferencesUtil.getInstance(context).getInt(Key.SAMPLE_INT);
 * AppPreferencesEnumExample.getInstance(context).set(Key.SAMPLE_INT, sampleInt);
 *
 * If SharedPreferencesUtil.getInstance(Context) has been called once, you can
...
public class SharedPreferencesUtil {
    ...
    private static SharedPreferencesUtil sSharedPrefs;
    ...
    public static SharedPreferencesUtil getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new SharedPreferencesUtil(context.getApplicationContext());
        }
        return sSharedPrefs;
    }
